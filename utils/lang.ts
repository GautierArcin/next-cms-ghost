...
export const lang: KeyObjectMap = {
  ...
  fr: {
    A_COLLECTION_OF: `Une collection de`,
    BY: `de`,
    BY_THIS_AUTHOR: `par l'auteur`,
    GOTO_FRONT_PAGE: `Aller à la page d'accueuil`,
    LATEST_POSTS: `Derniers posts`,
    IS_REQUIRED: `est requis`,
    MIN_READ: `minute(s) de lecture`,
    MORE_IN: `davantage`,
    MORE_POSTS: `Voir davantage de posts`,
    MORE_POSTS_SM: `voir davantage de posts`,
    NEXT: `Suivant`,
    NO_POSTS: `Pas de posts`,
    ...
    READ: `Lire`,
    SEE_ALL: `Voir tout`,
    SUBSCRIBED_TO: `Vous vous êtes bien abonné à`,
    WEBSITE: `Site`,
    MULTIPLE_AUTHORS: `Plusieurs auteurs`,
    DARK_MODE: `Mode dark`,
    CHECK_YOUR_INBOX: `Vérifiez votre boîte de réception et cliquez sur le lien pour confirmer votre abonnement.`,
    EMAIL: `Email`,
    ENTER_VALID_EMAIL: `Veuillez saisir une adresse électronique valide`,
    GREAT: `Bien`,
    SUBSCRIBE: `S'abonner`,
    SUBSCRIBE_OVERLAY: `Restez à jour ! Recevez tous les messages les plus récents et les plus intéressants directement dans votre boîte de réception.`,
    SUBSCRIBE_SECTION: `Recevez les derniers messages directement dans votre boîte de réception.`,
    SUBSCRIBE_TO: `S'abonner à`,
    SUBSCRIBED_FAILED: `Impossible de s'inscrire ! Le lien d'inscription n'est pas valide.`,
    YOUR_EMAIL: `votreemail@example.com`,
    AT_LEAST: `au moins`,
    CHARACTERS_LONG: `caractères longs`,
    ...
    FULL_NAME_MUST_BE: `Le nom complet doit être`,
    INVALID_EMAIL_ADDRESS: `Adresse mail invalide`,
    MESSAGE_MUST_BE: `Votre message doit être`,
    MESSAGE_SENT: `Merci, votre message a été envoyé !`,
    MESSAGE_TEXT_IS_REQUIRED: `Un message est requis`,
    ONE_SECOND: `Veuillez patienter ...`,
    SENDING_FAILED: `Oups :-( envoi échoué. Erreur`,
    PLEASE_SELECT: `Please select.`,
